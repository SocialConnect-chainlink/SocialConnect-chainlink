"use client";
import{a as _,b}from"./chunk-GKRHETFQ.js";import{da as w,ea as g,l as x,m as u,n as m}from"./chunk-WGR3KZ2U.js";import v from"@ant-design/icons";import y from"react";var k=({className:r="",...n})=>y.createElement(v,{className:r,component:_,...n}),D=k;import{hasPaymentPassword as z,isNullish as P}from"@particle-network/auth-core";import{useEffect as S,useState as j}from"react";var V=()=>{let[r,n]=j(z()),{setPaymentPassword:l,userInfo:i,modalOptions:e,showAccountTipModal:o}=g();return S(()=>{var t;n(Boolean((t=i==null?void 0:i.security_account)==null?void 0:t.has_set_payment_password))},[i]),{hasSetPaymentPassword:r,setPaymentPassword:l,showSetPaymentPasswordOrConfirm:t=>{var f,s,a,d;r?t():((f=e.promptSettingConfig)==null?void 0:f.promptPaymentPasswordSettingWhenSign)===2||((s=e.promptSettingConfig)==null?void 0:s.promptPaymentPasswordSettingWhenSign)===3?o({visible:!0,confirm:t}):(((a=e.promptSettingConfig)==null?void 0:a.promptPaymentPasswordSettingWhenSign)||P((d=e.promptSettingConfig)==null?void 0:d.promptPaymentPasswordSettingWhenSign))&&!u(m.PN_OPEN_SET_PAYMENT_PASSWORD)?(x(m.PN_OPEN_SET_PAYMENT_PASSWORD,"1"),o({visible:!0,confirm:t})):t()}}};var L=`.info-sign {
  display: flex;
...
`;import{Badge as N}from"antd";import A from"crypto-js/md5.js";import h from"lodash/cloneDeep.js";import c,{useEffect as C,useMemo as E,useState as O}from"react";var M=r=>{var f;let{userInfo:n}=r,l=w(),{modalOptions:i}=g(),e=E(()=>{let s=`${i.appId}_${n==null?void 0:n.uuid}`;return`account_security_${A(s)}`},[i.appId,n==null?void 0:n.uuid]),[o,p]=O({account:{name:"Account & Security",display:!0,badge:!1}});C(()=>{if((n==null?void 0:n.security_account)&&!!e&&!localStorage.getItem(e)){let{has_set_master_password:s,has_set_payment_password:a}=(n==null?void 0:n.security_account)||{};!s||!a?o.account.badge=!0:o.account.badge=!1}else o.account.badge=!1;p(h(o))},[n==null?void 0:n.security_account,e]);let t=c.createElement("div",{className:"item",onClick:()=>{o.account.badge=!1,p(h(o)),l("/account/security"),localStorage.setItem(e,"true")}},c.createElement(N,{dot:!!o.account.badge},c.createElement(b,{className:"wallet-icon",name:"security_icon"})));return c.createElement("div",{className:"top-menu-list"},!!((f=o==null?void 0:o.account)!=null&&f.display)&&t)},nn=M;export{D as a,V as b,L as c,nn as d};
