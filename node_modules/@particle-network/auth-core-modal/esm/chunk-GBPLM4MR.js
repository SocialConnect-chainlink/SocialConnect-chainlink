...
`;function z(j){let{themeType:m}=t(),u=h(()=>m==="dark"?(n(),k(s)).default:(a(),k(w)).default,[m]);return o.createElement(o.Fragment,null,o.createElement("style",null,e),o.createElement("div",{className:"footer-box",...j},o.createElement("img",{className:"footer",src:u,alt:""})))}var N=z;export{N as a};
