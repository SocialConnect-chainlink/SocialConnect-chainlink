...
var IframeWalletPlugin = () => {
  ...
  useEffect(() => {
    var _a2, _b, _c;
    if (((_a2 = modalOptions.wallet) == null ? void 0 : _a2.visible) !== false) {
      const walletOptions = {
        ...modalOptions.wallet,
      ...
      return () => {
        var _a3, _b2;
        if (typeof window !== "undefined") {
          (_a3 = window.particleAuth) == null ? void 0 : _a3.off(AuthCoreEvent.ParticleAuthDisconnect, onDisconnect);
  ...
  useEffect(() => {
    var _a2;
    if (connected && ((_a2 = modalOptions.wallet) == null ? void 0 : _a2.visible) !== false) {
  ...
  }, [connected, provider, wallet, (_a = modalOptions.wallet) == null ? void 0 : _a.visible, customEventHandler]);
...
//# sourceMappingURL=iframeWalletPlugin-YTQRSKRK.js.map
