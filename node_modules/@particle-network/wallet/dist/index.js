...
var sendEthereumEvent = (event, args) => {
  var _a, _b;
  const message = buildMessage({ name: event, args }, "ethereum-event" /* EthereumEvent */);
...
var _WalletEntryPlugin = class {
  constructor() {
    __privateAdd(this, _onMessage, (event) => {
      ...
      if (((_a = event.data) == null ? void 0 : _a.type) === IframeWalletMessageType) {
        ...
        if (messageType === "ethereum-rpc" /* EthereumRpc */ || messageType === "solana-rpc" /* SolanaRpc */) {
  ...
  setWalletCore(walletCore, customEventHandler) {
    ...
    if (this.walletCore) {
      (_b = (_a = this.walletCore.ethereum) == null ? void 0 : _a.removeListener) == null ? void 0 : _b.call(_a, "accountsChanged", __privateGet(this, _onEthereumAccountsChanged));
      (_d = (_c = this.walletCore.ethereum) == null ? void 0 : _c.removeListener) == null ? void 0 : _d.call(_c, "chainChanged", __privateGet(this, _onEthereumChainChanged));
    }
    this.walletCore = walletCore;
    this.customEventHandler = customEventHandler;
    if (this.walletCore.ethereum) {
      (_f = (_e = this.walletCore.ethereum) == null ? void 0 : _e.removeListener) == null ? void 0 : _f.call(_e, "accountsChanged", __privateGet(this, _onEthereumAccountsChanged));
      (_h = (_g = this.walletCore.ethereum) == null ? void 0 : _g.on) == null ? void 0 : _h.call(_g, "accountsChanged", __privateGet(this, _onEthereumAccountsChanged));
      (_j = (_i = this.walletCore.ethereum) == null ? void 0 : _i.removeListener) == null ? void 0 : _j.call(_i, "chainChanged", __privateGet(this, _onEthereumChainChanged));
      (_l = (_k = this.walletCore.ethereum) == null ? void 0 : _k.on) == null ? void 0 : _l.call(_k, "chainChanged", __privateGet(this, _onEthereumChainChanged));
    }
  }
  walletEntryCreate() {
    this.destroy();
  ...
  getWalletUrl(options) {
    ...
    if (this.openTimestamp) {
      url += `&openTimestamp=${this.openTimestamp}`;
    }
    if (customStyle) {
  ...
  setButtonStorageData(data) {
    ...
    const position = this.walletEntryOptions.entryPosition || "bottom-right" /* BR */;
  ...
  getButtonStorageData() {
    ...
    if (width && height && (width != innerWidth || height != innerHeight)) {
      ...
      return {
        x: innerWidth,
        y: innerHeight,
        position: position || ((_e = this.walletEntryOptions) == null ? void 0 : _e.entryPosition) || "bottom-right" /* BR */,
        direction: "right"
      };
    }
    return {
      x: Number(x) || 0,
      y: Number(y) || 0,
      position: position || ((_f = this.walletEntryOptions) == null ? void 0 : _f.entryPosition) || "bottom-right" /* BR */,
      direction
    };
  }
  ...
  async walletEntryRander() {
    ...
    if (btnX && btnY) {
      ...
      const position = this.walletEntryOptions.entryPosition || "bottom-left" /* BL */;
      let top, left;
