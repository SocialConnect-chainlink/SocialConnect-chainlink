...
declare const userStorage: {
    ...
    setLatestAuthType(authType: string | AuthType): void;
    getLatestAuthType(): AuthType | null;
    updateWallet(info: WalletInfo): void;
    updateCognitoResult(result: CognitoResult): void;
    updateSecurityAccount(account: SecurityAccount): void;
