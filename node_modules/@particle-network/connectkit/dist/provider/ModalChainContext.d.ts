import type { Chain, ChainInfo, ConnectConfig, ParticleConnect, Provider } from '@particle-network/connectors';
...
export declare function ParticleKitChainProvider({ chains, children, chain, setChain, userChains, provider, connectKit, connectId, language, options, }: ParticleKitChainProviderProps): JSX.Element;
